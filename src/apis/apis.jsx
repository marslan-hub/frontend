...
// const live_url = "https://server.ecofriendlycarwash.ae/";
...
export default class Api {
  ...
  static generateAffiliateLink = async (data) => {
    ...
    try {
      const res = await axios.post(
          api_url + `generate-affiliate-person-link`,
          data,
          token,
      );
      return res.data;
  ...
  // // generate affiliate link
  static UpdateGenerateAffiliateLink = async (data) => {
    await checkLogin();
    try {
      const res = await axios.post(
          api_url + `update-generate-affiliate-person-link`,
          data,
          token,
      );
      return res.data;
  ...
  static adminDeleteLink = async (data) => {
    ...
    try {
      const res = await axios.post(
          api_url + `delete-affiliate-person-link`,
          data,
          token,
      );
      return res.data;
  ...
  static getAffiliateLinkByUser = async (data) => {
    ...
    try {
      const res = await axios.post(
          api_url + `all-affiliate-links-by-id`,
          data,
          token,
      );
      return res.data;
  ...
  static getLinkDetails = async (data) => {
    console.log('here');
    await checkLogin();
    try {
      const res = await axios.post(
          api_url + `all-affiliate-links-details-by-code`,
          data,
          token,
      );
      return res.data;
  ...
  static getAllBookingsByDate = async (data) => {
    try {
      console.log('data');
      console.log(data);
      const res = await axios.post(api_url + `all-booking-by-date`, data);
      return res.data;
    } catch (error) {
      return error.data;
    }
  ...
  static adminAssignBooking = async (data) => {
    ...
    try {
      const res = await axios.post(
          api_url + `assign-cleaner-to-booking`,
          data,
          token,
      );
      return res.data;
  ...
  static allBookingsByCleanerId = async (data) => {
    try {
      const res = await axios.post(
          api_url + `cleaner-bookings-by-id`,
          data,
          token,
      );
      return res.data;
  ...
  static userSigninAndSignupByPhone = async (data) => {
    try {
      const res = await axios.post(
          api_url + `user-signin-signup-by-phone`,
          data,
      );
      return res.data;
    } catch (error) {
  ...
  static getAllCleanerCounts = async (data) => {
    try {
      const res = await axios.post(
          api_url + `get-all-cleaner-dashboard-counts`,
          data,
      );
      return res.data;
    } catch (error) {
  ...
  static getAllUserCounts = async (data) => {
    try {
      const res = await axios.post(
          api_url + `get-all-user-dashboard-counts`,
          data,
      );
      return res.data;
    } catch (error) {
  ...
  // link by id
  static linkById = async (data) => {
    try {
      const res = await axios.post(api_url + `link-by-id`, data);
      return res.data;
    } catch (error) {
      return error.data;
    }
  ...
  static requestsByAffiliateId = async (data) => {
    try {
      const res = await axios.post(
          api_url + `all-approval-request-by-affiliate`,
          data,
      );
      return res.data;
    } catch (error) {
  ...
  static generateLinkDesc = async (data) => {
    try {
      const res = await axios.post(
          api_url + `generate-affiliate-person-link-desc`,
          data,
      );
      return res.data;
    } catch (error) {
  ...
  // // update link by code
  static updateGenerateLinkDesc = async (data) => {
    try {
      const res = await axios.post(
          api_url + `update-generate-affiliate-person-link-desc`,
          data,
      );
      return res.data;
    } catch (error) {
  ...
  static allPlanByCarAndPlanType = async (data) => {
    try {
      const res = await axios.post(
          api_url + `plan-by-car-type-plan-type`,
          data,
      );
      return res.data;
    } catch (error) {
  ...
  static linkDescByCodeUser = async (data) => {
    try {
      const res = await axios.post(
          api_url + `get-link-desc-by-user-code`,
          data,
      );
      return res.data;
    } catch (error) {
  ...
  static linkDescByCodeUserOne = async (data) => {
    try {
      const res = await axios.post(
          api_url + `get-link-desc-by-user-code-one`,
          data,
      );
      return res.data;
    } catch (error) {
  ...
  static updateMonthlyWashDate = async (data) => {
    try {
      console.log(data);
      const res = await axios.put(
          api_url + `update-wash-date/${data.id}`,
          data,
      );
      return res.data;
    } catch (error) {
  ...
  static getAffiliateCommmission = async (data) => {
    try {
      ...
      console.log(data);
      const res = await axios.post(api_url + `get-Affiliate-Commmission`, data);
      return res.data;
    } catch (error) {
      return error.data;
    }
  ...
  static getAffiliateCommmissionDetails = async (id) => {
    try {
      const data = {
        userId: id,
      };
      const res = await axios.post(
          api_url + `get-Affiliate-Commmission-details`,
          data,
      );
      return res.data;
    } catch (error) {
  ...
  static getAllBookingAcrd = async () => {
    try {
      // const data = {
      //   userId: id,
      // };
      const res = await axios.get(
          api_url + `bookings-dates`,
      );
      return res.data;
    } catch (error) {
      return error.data;
