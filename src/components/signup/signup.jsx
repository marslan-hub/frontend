...
function UserSignUp() {
    ...
    async function submitForm(e) {
        ...
        if (password != repassword) // check password and Confirm password
        {
                    ...
                    <form onSubmit={submitForm}>
                        <div className=' load-form'>
                            ...
                            <div className='form-buttons'>
                                <button type={'submit'} style={{ fontSize: '14px', background: "#FF7B00" }} className='button-primary'>Sign Up</button>
                            </div>
