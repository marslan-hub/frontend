...
function Slot() {
  ...
  useEffect(async ()=>{
    const res=await Api.getAllSlots();
    if (res.status == '200') {
      setSlots(res.data);
    }
  ...
  async function add(e) {
    ...
    if (reqType === false) {
      ...
      const res=await Api.adminAddSlot(data);
      ...
      const res=await Api.updateSlot(data);
  ...
  async function Delete(id) {
    ...
    const res= await Api.adminDeleteSlot(data);
    console.log(res);
  ...
  async function edit(id) {
    ...
    console.log(reqType);
    const res=await Api.slotById(data);
    if (res.status == '200') {
