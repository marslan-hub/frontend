...
function CleanerExtraFeatures() {
  ...
  useEffect(async ()=>{
    const res=await Api.getAllExtraFeatures();
    if (res.status == '200') {
  ...
  async function add(e) {
    ...
    const res=await Api.adminAddExtraFeature(data);
  ...
  async function Delete(id) {
    ...
    const res= await Api.adminDeleteExtraFeature(data);
...
export default CleanerExtraFeatures;
