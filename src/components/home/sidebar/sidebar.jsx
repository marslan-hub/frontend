...
import close from '../../../assets/images/closeOut.png';
    ...
    <div className="sidebar-wrapper" style={{display: sidebarDisp}}>
      <div
        className={`sidebar animate__animated ${
          sidebarDisp === 'block' ? 'animate__fadeInLeft' : ''
        }`}
      >
        <div className="sidebar-cont">
          ...
          <div className="sidebar-top">
            ...
            <p className="admin-name" style={style}>
              ...
              authData.type == 'admin' ? (
                <>
                  ...
                  <div className="sidebar-links">
                    ...
                    <Link to={'/cleaner'} style={{color: 'rgb(255, 123, 0)'}}>
                      Cleaners
                    </Link>
                  </div>
                  <div className="sidebar-links">
                  ...
                  <div className="sidebar-links">
                    ...
                    <Link to={'/booking'} style={{color: 'rgb(255, 123, 0)'}}>
                      Bookings
                    </Link>
                  </div>
                  <div className="sidebar-links">
                  ...
                  <div className="sidebar-links">
                    ...
                    <Link to={'/plans'} style={{color: 'rgb(255, 123, 0)'}}>
                      Plans
                    </Link>
                  </div>
                  <div className="sidebar-links">
                    {/* <p style={{ background: dispBar.color7 ? "rgb(255, 123, 0)" : "transparent" }}></p>*/}
                    {/* <img src={image.image7} alt="" />*/}
                    <Link to={'/slots'} style={{color: 'rgb(255, 123, 0)'}}>
                      Slots
                    </Link>
                  </div>
                  <div className="sidebar-links">
